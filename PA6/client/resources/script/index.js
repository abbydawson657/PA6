...
function handleEditClick() {
    makeEditable();
    hideButtons();
    var buttomHTML = "<button=\"btn btn-primary btn-lg\" onclick =\"handleEditSave("+myBook.id+")\">Save</button>"
...
function handleNewClick() {
    makeEditable();
    hideButtons();
    var buttomHTML = "<button=\"btn btn-primary btn-lg\" onclick =\"handleNewSave()\">Save</button>"
    buttomHTML += "<button class=\"btn btn-warning btn-lg btn-cancle\" onclick =\"handleCancelSave()\">Cancel</button>"
...
function makeEditable() {
    ocument.getElementById("bookTitle").readOnly=false;
...
function makeReadOnly() {
    ocument.getElementById("bookTitle").readOnly=true;
